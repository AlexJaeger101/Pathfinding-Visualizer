...
{
public:
	//please add a letter description to the mDescription array below when you add a new type of steering
	enum SteeringType
	{
		INVALID_TYPE = -1,
		MOVE_TO,
	...
	std::string mDescriptions[NUM_TYPES] = { "m" };

	const std::string& getDescription() const { return mDescriptions[mType]; };
