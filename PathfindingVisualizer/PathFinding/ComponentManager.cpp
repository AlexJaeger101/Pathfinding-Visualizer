...
void ComponentManager::update(double elapsedTime)
{
	updateSteering(elapsedTime);
	updatePhysics(elapsedTime);
}

void ComponentManager::updatePhysics(double elapsedTime)
{
	for (auto& it : mPhysicsComponentMap)
	{
...
void ComponentManager::updateSteering(double elapsedTime)
{
	for (auto& it : mSteeringComponentMap)
	{
